...
- When creating `Copilot_Execution.md` from the first time, copy `# AFFECTED MODULES` section from `Copilot_Planning.md`.
- When updating `Copilot_Execution.md`, carefully review `# AFFECTED MODULES` and fix this section if necessary.
